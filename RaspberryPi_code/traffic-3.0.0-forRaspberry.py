...
while True:
    ...
    with lock:
        if laptop_trigger is not None:
            combined_trigger = pi_trigger or laptop_trigger
            print(f"\n Sending to Arduino: Laptop={laptop_trigger}, Pi={pi_trigger}")
            if combined_trigger and arduino:
                try:
                ...
                print("No trigger sent (no movement).")
